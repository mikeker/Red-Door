...
/**
 * @file
 * Template for Red Door Front
 *
 * Variables:
 * - $css_id: An optional CSS id to use for the layout.
 * - $content: An array of content, each item in the array is keyed to one
 * panel of the layout. This layout supports the following sections:
 *     header, contentmain, sidebar, footer (source in that order)
 */
?>
<div class="red-door-front <?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
